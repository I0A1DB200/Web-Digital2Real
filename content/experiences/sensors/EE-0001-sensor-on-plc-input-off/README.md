...
| Field | Value |
|---|---|
| Editorial ID | `EE-0001` |
| Technical ID | `EXP-SENSOR-SIGNAL-001` |
| Domain | Industrial I/O — digital signal path |
...
The discarded loose-termination image is not part of this package.
